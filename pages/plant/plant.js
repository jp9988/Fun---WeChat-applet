...
Page({
  ...
  getToken:function(base64){
    ...
    wx.request({
      ...
      success:res=>{
        ...
        that.plantId(res.data.access_token,base64)
      }
    })
  },

  //植物识别
  plantId:function(token,base64){
    that = this;
      ...
      success:res=>{
        ...
        if(res.data.result != null){
          for(var i = 0;i<res.data.result.length;i++){
            ...
            content[i].score = res.data.result[i].score.toFixed(3);
          }
        }
        wx.hideLoading();
        wx.showToast({
  ...
  // numClick:function(){
    //取float类型小数点后的位数
    // var num = 0.79206174612045;
    // console.log(num.toFixed(3));
    // console.log(Math.round(num*1000)/1000)
    // var num = "0.79206174612045";
    // console.log(num.substring(0,num.indexOf(".")+3))
  // },
